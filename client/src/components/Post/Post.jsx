      ...
      <div className="footer">
        <div className="buttons">
          { post?.likes?.includes(currentUser?.result._id) ? (
            <button onClick={setdisLikePost} style={{backgroundColor:"white", border:"none"}}>
            <AiFillLike className="like-button"  />{" "} 
            <span>{post.likes.length}</span>
            </button>
          ) : (
            <button onClick={setLikePost} style={{backgroundColor:"white", border:"none"}}>
            <AiOutlineLike />
            </button>    
          )}
